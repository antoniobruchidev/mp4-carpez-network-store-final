...
STATICFILES_DIRS = [
    ...
    (
        "images",
        "/media/storage/dev/mp4-final/mp4-carpez-network-store-final/static/images",
    ),
    (
        "tailwind",
        "/media/storage/dev/mp4-final/mp4-carpez-network-store-final/static/tailwind",
    ),
]
...
if USE_AWS:
    ...
    DATABASES = {
        "default": dj_database_url.parse(config("CODE_INSTITUTE_POSTGRES_DB_URL"))
    }
else:
